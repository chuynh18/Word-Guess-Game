...
function updateWinLossDisplay() { // NOT TO BE USED MANUALLY - perhaps you were looking for newRound()?
    ...
    // this function blinks obnoxiously.  args:  (str) color e.g. "red" or "#ff0000", (int) # of times to blink e.g. 1, 2, 3, 4, (int) adjusts how quickly the page blinks.  larger numbers are slower
